...
#         self.executed_actions.clear()  # 清空已执行的动作
#         return obs, info

#     def step(self, action):
#         if action in self.executed_actions:
#             print(f"Action {action} already executed in this episode. Skipping.")
#             return self.current_obs, 0.0, False, False, {}

#         print(f"Action received in step function: {action}")
#         obs, reward, done, truncated, info = self._gym_env.step(action)
#         self.executed_actions.add(action)  # 记录已执行的动作

#         front_dim = self.rho_pos()
#         rho_values = obs[front_dim:front_dim + self._env.n_line]
...
#         if len(to_disconnect) > 0: 
#             gym_action = self.initial_outage_act_2_gym(to_disconnect, self._env.dim_topo, len(self._gym_env.action_space))
#             print(f"Generated gym action to disconnect lines: {gym_action}")
#             obs, reward, done, truncated, info = self._gym_env.step(gym_action)
#         else:
#             done = True
...
#                 "gen_q": self._env.n_gen,
#                 "gen_v": self._env.n_gen,
#                 "gen_margin_up": self._env.n_gen,
#                 "gen_margin_down": self._env.n_gen,
#                 "gen_theta": self._env.n_gen,
#                 "load_p": self._env.n_load,
#                 "load_q": self._env.n_load,
#                 "load_v": self._env.n_load,
#                 "load_theta": self._env.n_load,
#                 "p_or": self._env.n_line,
#                 "q_or": self._env.n_line,
#                 "a_or": self._env.n_line,
#                 "v_or": self._env.n_line,
#                 "theta_or": self._env.n_line,
#                 "p_ex": self._env.n_line,
#                 "q_ex": self._env.n_line,
#                 "a_ex": self._env.n_line,
#                 "v_ex": self._env.n_line,
#                 "theta_ex": self._env.n_line,
#                 "line_status": self._env.n_line,
#                 "timestep_overflow": self._env.n_line,
#                 "topo_vect": self._env.dim_topo,
#                 "time_before_cooldown_line": self._env.n_line,
#                 "time_before_cooldown_sub": self._env.n_sub,
#                 "time_next_maintenance": self._env.n_line,
#                 "duration_next_maintenance": self._env.n_line,
#                 "target_dispatch": self._env.n_gen,
#                 "actual_dispatch": self._env.n_gen,
#                 "storage_charge": self._env.n_storage,
#                 "storage_power_target": self._env.n_storage,
#                 "storage_power": self._env.n_storage,
#                 "storage_theta": self._env.n_storage,
#                 "curtailment": self._env.n_gen,
#                 "curtailment_limit": self._env.n_gen,
#                 "curtailment_mw": self._env.n_gen,
#                 "curtailment_limit_mw": self._env.n_gen,
#                 "thermal_limit": self._env.n_line,
#                 "is_alarm_illegal": 1,
#                 "time_since_last_alarm": 1,
#                 "last_alarm": self._env.dim_alarms,
#                 "attention_budget": 1,
#                 "was_alarm_used_after_game_over": 1,
#                 "delta_time": 1,
#                 "active_alert": self._env.dim_alerts,
#                 "time_since_last_alert": self._env.dim_alarms,
#                 "alert_duration": self._env.dim_alarms,
#                 "time_since_last_attack": self._env.dim_alarms,
#                 "was_alert_used_after_attack": self._env.dim_alarms,
#                 "attack_under_alert": self._env.dim_alarms,
#                 "max_step": 1,
#                 "delta_time": 1,
#                 "prod_p": self._env.n_gen,
#                 "prod_q": self._env.n_gen,
#                 "prod_v": self._env.n_gen,
#                 "gen_p_before_curtail": self._env.n_gen,
#                 "curtailment_limit_effective": self._env.n_gen
#             }.get(attr_name, 0)
#             front_dim += dim_value
#         return front_dim
...
class OutageEnv(gym.Env):
    def __init__(self, 
        ...
        #     attr_to_keep = self.obs_attr_to_keep
        # )
        self._gym_env.observation_space = BoxGymObsSpace(self._env.observation_space,
        attr_to_keep=["gen_p", "load_p","line_status","rho","topo_vect","connectivity_matrix"],
        ...
        #     attr_to_keep = self.action_attr_to_keep
        # )
        self._gym_env.action_space= DiscreteActSpace(self._env.action_space,attr_to_keep=[ "change_bus","set_line_status_simple"])
        self.action_space = self._gym_env.action_space
